...
(async () => {
  ...
  const modalText = await page.evaluate(() => {
    const modal = document.querySelector('.glass-panel.animate-fade-in');
    return modal ? modal.textContent : 'MODAL CLOSED';
  });
  console.log("Modal state:", modalText.substring(0, 50));
